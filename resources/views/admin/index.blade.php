    ...
    <div class="max-w-6xl mx-auto">
        ...
        <form action="{{ route('admin.store') }}" method="POST" x-data="adminData">
            ...
            <div class="flex items-center space-x-4 mb-4 px-4">
                <input type="text" x-model="search" placeholder="Cari nama kecamatan / MPP / Dinas..." class="flex-1 border border-gray-200 rounded-full px-4 py-2 text-sm text-gray-800 focus:outline-none focus:border-blue-300 focus:ring-1 focus:ring-blue-300">
                ...
                <div class="bg-white border border-gray-100 rounded-lg shadow-sm overflow-hidden" 
                    ...
                    <div class="flex justify-between items-center px-5 py-3 bg-white hover:bg-gray-50 transition-colors group">
                        ...
                        <div class="flex items-center space-x-4 shrink-0 min-w-0 ml-4">
                            <div class="flex items-center space-x-2 transition-opacity" x-show="expanded" style="display: none;">
                                <button type="button" onclick="editLokasi('{{ $nama_kecamatan }}')" class="text-blue-500 hover:text-blue-700" title="Ubah Nama Lokasi">
                                ...
                                <button type="button" onclick="deleteLokasi('{{ $nama_kecamatan }}')" class="text-red-500 hover:text-red-700" title="Hapus Lokasi Ini">
                            ...
                            @foreach($layananTypes as $jenis)
                                ...
                                <div class="relative group">
                                    <div class="flex justify-between items-center mb-1">
                                        ...
                                        <button type="button" onclick="deleteLayanan('{{ $jenis }}')" class="text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity" title="Hapus Layanan Ini">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                        </button>
                                    </div>
                                    @if($val)
