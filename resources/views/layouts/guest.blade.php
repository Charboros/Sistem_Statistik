...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative overflow-hidden bg-gradient-to-br from-[#153e75] via-[#1e4e8c] to-[#0d2a54] animate-gradient-x">
            ...
            <div class="absolute top-0 left-0 w-72 h-72 bg-white opacity-5 rounded-full mix-blend-overlay filter blur-xl animate-blob"></div>
            ...
            <div class="z-10 w-full sm:max-w-md mt-6 px-6 py-8 bg-white/10 backdrop-blur-md shadow-2xl border border-white/20 sm:rounded-2xl">
                {{ $slot }}
            </div>
        </div>
    </body>
